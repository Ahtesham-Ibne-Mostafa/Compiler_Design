...
static const yytype_int16 yyrline[] =
{
    ...
    1180,  1189,  1201,  1213,  1234,  1257,  1265,  1276,  1299
};
#endif
...
#line 558 "24241309.y"
          {
			...
			ForNode* forNode = new ForNode(
				(StmtNode*)yyvsp[-4]->get_ast_node(),
				(StmtNode*)yyvsp[-3]->get_ast_node(),
...
#line 1214 "24241309.y"
		...
		VarNode* originalVar = (VarNode*)yyvsp[-1]->get_ast_node();
		VarNode* lhsVar = new VarNode(originalVar->get_name(), yyvsp[-1]->getvartype());
		VarNode* rhsVar = new VarNode(originalVar->get_name(), yyvsp[-1]->getvartype());
		ConstNode* oneNode = new ConstNode("1", "int");
		BinaryOpNode* addNode = new BinaryOpNode("+", rhsVar, oneNode, yyvsp[-1]->getvartype());
		AssignNode* assignNode = new AssignNode(lhsVar, addNode, yyvsp[-1]->getvartype());
		yyval->set_ast_node(assignNode);
...
#line 1235 "24241309.y"
		...
		VarNode* rhsVar = new VarNode(originalVar->get_name(), yyvsp[-1]->getvartype());
		ConstNode* oneNode = new ConstNode("1", "int");
		BinaryOpNode* subNode = new BinaryOpNode("-", rhsVar, oneNode, yyvsp[-1]->getvartype());
		AssignNode* assignNode = new AssignNode(lhsVar, subNode, yyvsp[-1]->getvartype());
		yyval->set_ast_node(assignNode);
