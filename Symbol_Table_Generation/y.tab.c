...
{
       0,    78,    78,    90,    97,   106,   113,   122,   122,   161,
     161,   186,   197,   208,   219,   232,   247,   263,   275,   282,
     289,   298,   305,   313,   321,   332,   339,   348,   355,   363,
     370,   377,   384,   391,   398,   405,   412,   421,   428,   437,
     445,   454,   461,   470,   477,   486,   493,   502,   510,   519,
     526,   535,   542,   549,   558,   565,   572,   579,   586,   593,
     600,   609,   617,   625,   632
};
#endif
...
#line 161 "syntax_analyzer.y"
    {
			...
			current_return_type = (yyvsp[(1) - (4)])->getname();
			
			symbol_info* func_symbol = new symbol_info((yyvsp[(2) - (4)])->getname(), "ID");
			func_symbol->set_return_type((yyvsp[(1) - (4)])->getname());
